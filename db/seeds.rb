...
#Admin User
User.create(email: "adminTest1@gmail.com",password: "password" ,user_name: "admin1") #user_id = 2
Admin.create(user_id: 2)

#Vendor User
User.create(email: "vendorTest1@gmail.com",password: "password" ,user_name: "vendor1") #user_id = 3
Vendor.create(user_id: "3",company_name: "company1", company_number: "012345", validated: true)

User.create(email: "vendorTest2@gmail.com",password: "password" ,user_name: "vendor2") #user_id =4
