...
GivenTask.create(set_date: "2021-05-01", due_date: "2021-05-05",priority: "3", repeatable: "3", task_id: "4")
...
Assignment.create(vendor_id: "4", given_task_id: GivenTask.last.given_task_id, complete_by:"2021-05-05" )
